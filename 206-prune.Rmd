...
Ok, so let's run this across chroms and 5353399 GLS

I imagine this is going to make a stupidly large ld file

zcat outputs/101/58-ibs-90.beagle.gz | cut -f 4- | gzip  > outputs/206/58-gls-90-for-ngsld.beagle.gz

zcat outputs/206/58-gls-90.beagle.gz | cut -f 1,2 | sed 's/:/_/g'| gzip > outputs/206/58-gls-90.pos.gz
...
Why not pull a snp every 10000 kb? 