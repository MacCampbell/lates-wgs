...
structure<-plot_structure(snp, facet=c("pop"), facet.order = c("Indonesia-K", "Indonesia-SU","Indonesia-SJ",
                                                               "Philippines","Taiwan","Vietnam","Cambodia",
                                                               "Thailand"),
               k=c(2,3,4,5))

structure$plot

ggsave("outputs/1211/taiwan-admixture-plot.pdf")
```
