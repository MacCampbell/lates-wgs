...
```{r}
meta<-m2
m <- as.matrix(read.table("outputs/100/58-ibs-90-3.covMat"))
eig <- eigen(m)
...
```{r}
PlotAdmix("outputs/100/58-K2-3.qopt", m2)
```
```{r}
...
-minInd   -GL 1 -ref  genome/GCF_001640805.2_TLL_Latcal_v3_genomic.fna -minMaf 0.05 \
