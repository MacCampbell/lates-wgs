...
```{r}
m48<-m114 %>% filter(Lineage %in% c("AUS","Mainstream","SEA")) %>% filter(Region %in% c("Indonesia-K","Philippines","Indonesia-SJ","Taiwan","Northern Territory","Papua New Guinea","Western Australia"))
...
-minInd 82 -bam bamlists/91.bamlist -ref genome/GCF_001640805.2_TLL_Latcal_v3_genomic.fna \
