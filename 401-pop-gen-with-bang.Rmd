...
First no labels
```{r, echo=FALSE}
PlotAdmixNoLabs<- function(file, meta) {
...
```{r}
PlotAdmixNoLabs("outputs/400/60-K2.qopt", meta)
```
...
#  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  theme(axis.text.x=element_blank()) +
  #scale_fill_viridis_d(option="viridis") +
  scale_fill_manual(values=c("#000004BF","#3B0F70BF","#8C2981BF"))+
  theme(axis.ticks.x = element_blank())
...
#  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  theme(axis.text.x=element_blank()) +
  #scale_fill_viridis_d(option="viridis") +
  scale_fill_manual(values=c("#8C2981BF","#000004BF","#3B0F70BF","#DE4968BF"))+
  theme(axis.ticks.x = element_blank())

}
k4<-PlotAdmixNoLabs4("outputs/207/58-K4-gls.qopt", m)
k4
```
...
ggsave("outputs/207/combined-k-plots.pdf", width=11, height=8.5)
```
