...
ggplot(rdf) + 
  ...
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  #scale_fill_viridis_d(option="viridis") +
  scale_fill_manual(values=c("#FE9F6DBF","#3B0F70BF","#8C2981BF","#DE4968BF","#000004BF"))

}
k5<-PlotAdmix5("outputs/207/58-K5-gls.qopt", m)
k5
```
...
401 has sample lists so we can pull out things for testing again.
