...
```{r}
PlotAdmix("outputs/207/58-K2-gls.qopt", m)

ggsave("outputs/207/k2.jpeg")
```
```{r}
...
```
```{r}
PlotAdmix("outputs/207/58-K4-gls.qopt", m)

ggsave("outputs/207/k4.jpeg")
```
```{r}
PlotAdmix("outputs/207/58-K5-gls.qopt", m)

ggsave("outputs/207/k5.jpeg")
```


```{r}
PlotAdmix("outputs/207/58-K6-gls.qopt", m)

ggsave("outputs/207/k6.jpeg")
```
...
```{r}
PlotAdmixNoLabs("outputs/207/58-K2-gls.qopt", m)
```
...
#  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  theme(axis.text.x=element_blank()) +
  #scale_fill_viridis_d(option="viridis") +
  scale_fill_manual(values=cs[1:2])+
  theme(axis.ticks.x = element_blank())

}
k2<-PlotAdmixNoLabs2("outputs/207/58-K2-gls.qopt", m)
k2
```
```{r}
...
#  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  theme(axis.text.x=element_blank()) +
  #scale_fill_viridis_d(option="viridis") +
  scale_fill_manual(values=c("#3B0F70BF","#8C2981BF","#000004BF"))+
  theme(axis.ticks.x = element_blank())

}
k3<-PlotAdmixNoLabs3("outputs/207/58-K3-gls.qopt", m)
k3
```
