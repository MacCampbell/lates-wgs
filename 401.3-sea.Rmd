...
m<-meta
sea<-m %>% filter(Lineage=="SEA")
```

```{sh, eval=FALSE}
bcftools view -S outputs/401/sea.samples outputs/401/pruned.vcf | bcftools +fill-tags | bcftools view -q 0.05:minor > outputs/401/sea-05.vcf

```

```{r}
path_to_file <- "outputs/401/sea-05.vcf"
...
ggsave("outputs/401/pca-adapt-sea.jpeg", width=15, height=5.5)
ggsave("outputs/401/Supplemental Figure S3.pdf", width=15, height=5.5)
