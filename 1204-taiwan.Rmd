...
m64 %>% select(Run) %>% write_tsv("bamlists/64-sample-names.txt")
```
...
bcftools view -s bamlists/64-sample-names.txt > outputs/1204/64.vcf
...
```{r}
path_to_file <- "outputs/1204/pruned.vcf"
...
```{r}
tree<-read.tree("outputs/1204/pruned.min4.phy.varsites.phy.contree")
