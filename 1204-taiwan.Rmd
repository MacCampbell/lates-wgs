...
```{r}
path_to_file <- "outputs/1204/pruned-01-maf01-45.vcf"
...
```{r}
m<-ms
vcf <-read.vcfR("outputs/1204/pruned-01-maf01-45.vcf") # from recalled and pruned snps in 1200
...
np2<-np %>% filter(pop %in% c("OceanPick","Taiwan","Cambodia")) 
