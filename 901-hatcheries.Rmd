...
#	-> Number of sites retained after filtering: 191224 
...
```{r}
meta<-m85 %>% filter(! Run %in% c("OceanPick11","OceanPick1","OceanPick20","OceanPick2","OceanPick8"))
...
pc12<-ggplot(covs) +
  ...
  scale_shape_manual(values=c(21,23,25,22,22,24)) +
