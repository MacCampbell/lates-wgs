...
```{r}
m <- as.matrix(read.table("outputs/900/70-ibs-90-lca01.covMat"))
eig <- eigen(m)
...
bcftools reheader --samples bamlists/71.names outputs/900/plink.vcf.gz | bcftools +fill-tags | bcftools view -q 0.05:minor | bcftools +prune -m 0.20 -w 10000  > outputs/1000/pruned.vcf
