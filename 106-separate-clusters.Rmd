...
min maf doesn't do anything, but leaving it in
	...
	-> Number of sites retained after filtering: 12 with minInd 15
	-> 
hmmm...
...
```{r, eval=FALSE}
vcfwgs<-read.vcfR(file="outputs/106/snps-wgs.vcf")
...
Neat! Combined with existing samples the 12 loci separate the fish into groups.
