...
srun -p high -t 05:00:00 --mem=32G --nodes=1 $HOME/angsd/misc/NGSadmix -P 12 -likes outputs/206/58-gls-90.beagle.gz -K 4 -o outputs/207/58-K5-gls &
...
```{r}
PlotAdmix("outputs/207/58-K3-gls.qopat", m58)
```
