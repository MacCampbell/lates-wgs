...
srun -p bigmemh -t 12:00:00 --mem=32G --nodes=1 --ntasks-per-node=1 --cpus-per-task=2 md5sum -c checksums.md5 > check.out 2> check.err


Manually combine, don't ask me why.
...
Need to align, but the options have changed! 
