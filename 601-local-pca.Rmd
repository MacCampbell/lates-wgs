...
```{r}
vcf<-read.vcfR(file="outputs/600/sea/NC_066837.1.vcf")
...
```{r}
vcf<-read.vcfR(file="outputs/600/sea/NC_066835.1.vcf")
genind<-vcfR2genind(vcf)
genind@pop<-factor(sea$Pop, levels=c("INA","MAL","THA"))
...
```{r}
vcf<-read.vcfR(file="outputs/600/sea/NC_066852.1.vcf")
genind<-vcfR2genind(vcf)
genind@pop<-factor(sea$Pop, levels=c("INA","MAL","THA"))
